...
const TypeDeReleveModal = ({isOpen, onClose, onConfirm, title, children, typeAction}) => {
    ...
    return (
        <Modal show={isOpen} onClose={onClose} popup>
            ...
            <Modal.Body>
                ...
                <div className="text-center">{children}</div> {/* Remplacez <p> par <div> */}
            </Modal.Body>
            <Modal.Footer>
...
export default TypeDeReleveModal;