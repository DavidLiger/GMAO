    ...
    return (
        <Modal show={isOpen} onClose={onClose} popup dismissible>
            ...
            <Modal.Body>
                ...
                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400 w-full text-center">Modifications
                    non enregistrées</h3>
                <p>{message}</p>
            </Modal.Body>
            <Modal.Footer>
                <div className="flex justify-center gap-4 items-center w-full">
                    <BioButton color="failure" onClick={onConfirm}>
                        <FaTrashAlt size={15} className="mt-0.5 mr-2"/> Quitter la page sans enregistrer
                    </BioButton>
                    <BioButton color="gray" onClick={onClose}>
                        <FaTimes size={15} className="mt-0.5 mr-2"/> Annuler
                    </BioButton>
                    <BioButton color={"success"} onClick={onSave}>
                        <FaSave size={15} className="mt-0.5 mr-2"/> Enregistrer et quitter la page
                    </BioButton>
                </div>
            </Modal.Footer>
        </Modal>
